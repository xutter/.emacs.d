(custom-set-variables
 ...
 '(package-selected-packages
   '(company-tabnine company-box markdown-preview-mode solarized-theme yasnippet which-key unicode-fonts treesit-auto treemacs rime restart-emacs rainbow-delimiters pyvenv powerline-evil plantuml-mode pdf-tools paredit org-bullets haskell-mode graphviz-dot-mode ef-themes diminish counsel-projectile cdlatex benchmark-init auctex all-the-icons))
